...
class TranscriptionApp:
    def __init__(self, root):
        ...
        try:
            ...
            self.client = MocoVoiceClient(self.api_key)
    ...
    def start_transcription(self):
        ...
        self.status_label['text'] = '状態: アップロード中...'
        self.root.update()
        ...
        try:
            ...
            # 文字起こし開始
            transcription_id = self.client.transcribe(file_path, options)
            ...
            # 結果待機
            result = self.client.wait_for_completion(transcription_id, update_status)
